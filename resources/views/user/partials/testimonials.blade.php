        ...
        <div class="row">
            ...
            <div class="offset-lg-3 col-lg-6">
                <div class="center-text">
                    <p>See what our customer have to say... We are enternally greatful to those customer who have been good enough to recommend us to friends and colleagues.</p>                
                </div>
            </div>
        </div>
        <!-- ***** Section Title End ***** -->
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="team-item">
                    <div class="team-content">
                        <i><img src="user/assets/images/testimonial-icon.png" alt=""></i>
