<div class="tab-pane fade" id="address" role="tabpanel" aria-labelledby="address-tab">
    <form action="{{ route('setting.address') }}" method="POST">
        @csrf
        <div class="mb-3">
            <label>Address</label>
        ...
        <div class="mb-3">
            <label>Mobile</label>
            <input class="form-control form-control-solid" value="{{ $setting->get('mobile') }}" name="mobile" type="number" placeholder="Enter mobile">
        </div>
